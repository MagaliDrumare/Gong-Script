...
const SCRIPTS: readonly DemoScript[] = [
  ...
  },
  {
    ...
    steps: 8,
    demoType: "Slides",
    coreMessage: "Connect Claude (or any MCP client) to OneStream data in a governed fashion — not shadow AI",
  },
  {
    ...
    steps: 12,
    demoType: "Live product",
    coreMessage: "Power users stop rebuilding Quick Views and Excel math — agent drills your cube data to explain variances",
  },
  {
    ...
    steps: 9,
    demoType: "Slides",
    coreMessage: "Maintain governed data while leveraging AI to maximize ROI on OneStream — not shadow AI",
  },
  {
    ...
    steps: 16,
    demoType: "Live product",
    coreMessage: "Agents automate variance drill, store trends, and month-end narrative so accountants analyze locations",
  },
  {
    ...
    steps: 13,
    demoType: "Live product",
    coreMessage: "Best forecast with the least effort — AI learns per account-store intersection and explains why numbers moved",
  },
];
